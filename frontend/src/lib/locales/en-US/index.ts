export const enUS = {
  ...
  models: {
    ...
    requiredModelPlaceholder: "Required - Select a model",
  ...
  simpleTransformations: {
    subtitle: "Reusable prompts that turn a source into summaries, insights, outlines — whatever you define.",
    try: "Try",
    sharedInstructions: "Shared instructions",
    sharedInstructionsDesc: "prepended to every transformation prompt",
  },
  simpleSettings: {
    subtitle: "How new sources get processed.",
    choose: "Choose…",
    documents: "Documents",
    documentsDesc: "how PDFs and uploads get parsed",
    webPages: "Web pages",
    webPagesDesc: "how URL sources get fetched",
    embedNewSources: "Embed new sources",
    embedNewSourcesDesc: "makes content searchable — free if your embedding model is local",
    askEachTime: "Ask each time",
    uploadedFiles: "Uploaded files",
    uploadedFilesDesc: "originals aren't needed once a source is processed",
    deleteWhenDone: "Delete when done",
    keepForever: "Keep forever",
  },
  simpleModels: {
    title: "Models",
    subtitle: "Connect a provider, pick your models.",
    yourModels: "Your models",
    yourModelsDesc: "One list per job, everything your connections offer. Pick a model and it's live.",
    chat: "Chat",
    chatDesc: "answers & transformations",
    embedding: "Embedding",
    embeddingDesc: "search & retrieval",
    voice: "Voice",
    voiceDesc: "podcast generation",
    transcription: "Transcription",
    transcriptionDesc: "audio sources",
    advancedHint: "Chat handles these unless you override them",
    followsChat: "Follows Chat",
    chooseModel: "Choose a model",
    chooseVoiceModel: "Choose a model to enable podcasts",
    chooseTranscriptionModel: "Choose a model to transcribe audio",
    searchModels: "Search models…",
    noModels: "No models available — check your connections below",
    discovering: "Asking the provider…",
    current: "current",
    useCustom: "Use \"{name}\"",
    clear: "Clear",
    connections: "Connections",
    connectionsDesc: "Where the models come from. Add a key and models appear above.",
    addConnection: "Add connection",
    noConnections: "No connections yet. Add one to get started.",
    chooseProvider: "Choose a provider",
    searchProviders: "Search providers…",
    noProviderFound: "No provider matches that",
    modelCount: "{count} models",
    connected: "Connected",
    test: "Test",
    apiKeySet: "API key",
    deleteWithModels: "This connection feeds {count} model(s). Removing it deletes them unless you move them to another connection.",
    migrateModelsTo: "Move models to:",
    keepModelsPlaceholder: "Delete the models",
    migrateAndDelete: "Move models & remove",
  },
  apiKeys: {
