...
import { ModelType, PROVIDER_DISPLAY_NAMES } from './provider-meta'
              ...
              {selectedModel ? (
                <>
                  ...
                  <span className="text-muted-foreground ml-1.5 text-xs">
                    · {PROVIDER_DISPLAY_NAMES[selectedModel.provider] || selectedModel.provider}
                  </span>
                </>
              ) : (
                placeholder
          ...
          <Command>
            ...
            <CommandList>
              ...
              {groups.map(({ cred, registered, discovered, isDiscovering }) => {
                ...
                const heading = sameProviderCount > 1 ? `${providerName} · ${cred.name}` : providerName
